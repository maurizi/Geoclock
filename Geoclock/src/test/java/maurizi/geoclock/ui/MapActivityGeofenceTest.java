...
public class MapActivityGeofenceTest {
  ...
  public void enabledAlarm_insideGeofence_getsActivated() {
    ...
    assertNotNull(
        "Alarm inside geofence should be scheduled", shadowAlarmManager.getNextScheduledAlarm());
  }
  ...
  public void enabledAlarm_outsideGeofence_notActivated() {
    ...
    assertNull(
        "Alarm outside geofence should not be scheduled",
  ...
  public void disabledAlarm_insideGeofence_notActivated() {
    ...
    assertNull(
        "Disabled alarm should not be scheduled", shadowAlarmManager.getNextScheduledAlarm());
  }
