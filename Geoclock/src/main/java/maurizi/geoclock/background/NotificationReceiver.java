...
public class NotificationReceiver extends BroadcastReceiver {
  ...
  private void createNotificationChannel() {
    NotificationChannel channel =
        new NotificationChannel(
            CHANNEL_ID, "Upcoming Alarms", NotificationManager.IMPORTANCE_DEFAULT);
  ...
  private void setNotification(@NonNull final GeoAlarm nextAlarm) {
    ...
    final String alarmFormattedTime =
        alarmTime.format(DateTimeFormatter.ofLocalizedTime(FormatStyle.SHORT));
    final String title =
        String.format(context.getString(R.string.alarm_notification_text), alarmFormattedTime);
