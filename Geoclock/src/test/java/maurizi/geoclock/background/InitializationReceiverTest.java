 ...
 *
 * <p>NOTE: Verifying that InitializationService.enqueueWork() was called is not straightforward in
 * Robolectric on API 26+ because JobIntentService uses JobScheduler.enqueue() (not schedule()),
 * which is not tracked by ShadowJobScheduler.getAllPendingJobs(). These tests instead verify the
 * correct intent-routing behavior: valid system intents trigger work, invalid ones do not.
