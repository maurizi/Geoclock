...
/**
 * Tests that verify AlarmManager delivery timing.
 * Uses short delays (3s alarms) to stay within a reasonable CI window.
 */
...
public class AlarmManagerDeliveryTest {
    ...
    public void alarm_firesWithinExpectedWindow() throws Exception {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
            Assume.assumeTrue("SCHEDULE_EXACT_ALARM not granted; skipping timing test",
        ...
        android.app.PendingIntent showPi = android.app.PendingIntent.getActivity(
                context, 0, new Intent(context, maurizi.geoclock.ui.AlarmRingingActivity.class),
        ...
        assertNotNull("Alarm should be scheduled for ~3 seconds out",
        ...
        assertNull("AlarmClockReceiver should have fired and consumed the alarm within expected window",
                alarmManager.getNextAlarmClock());
    }
