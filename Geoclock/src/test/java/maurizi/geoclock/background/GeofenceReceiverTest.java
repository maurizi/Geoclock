 ...
 *
 * NOTE: Tests that require a valid GeofencingEvent (ENTER/EXIT transitions with real geofencing
 * data) are not achievable in Robolectric because GeofencingEvent is a Play Services internal
 * class whose intent format is not publicly documented. Those paths are covered by instrumentation
 * tests in integration/GeofenceIntegrationTest.java.
 *
 * These unit tests cover the defensive/error paths and verify no crashes on malformed input.
 */
