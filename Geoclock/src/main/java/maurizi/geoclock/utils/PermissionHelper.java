...
/**
 * Encapsulates just-in-time permission checks for alarm-related permissions. Foreground location is
 * requested separately at app launch.
 */
public class PermissionHelper {
  ...
  /**
   * Requests alarm-related permissions in sequence with rationale dialogs. Call this when the user
   * saves or enables an alarm.
   *
   * @param activity the hosting activity
   * @param onComplete called after all permission requests are done (or skipped)
   */
  public static void requestAlarmPermissions(
      @NonNull FragmentActivity activity, @NonNull Runnable onComplete) {
    requestBackgroundLocation(
        ...
        () ->
            requestNotificationPermission(
                ...
                () ->
                    requestExactAlarm(
                        activity, () -> requestFullScreenIntent(activity, onComplete))));
  }

  private static void requestBackgroundLocation(
      @NonNull FragmentActivity activity, @NonNull Runnable next) {
  ...
  private static void requestExactAlarm(
      @NonNull FragmentActivity activity, @NonNull Runnable next) {
  ...
  @android.annotation.SuppressLint(
      "InlinedApi") // Guarded by needsFullScreenIntentPermission (API 34+)
  private static void requestFullScreenIntent(
      @NonNull FragmentActivity activity, @NonNull Runnable next) {
